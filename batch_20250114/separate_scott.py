...
def partiion_lines(lastlnum,lines):
 lines1 = []
 lines2 = []
 lines3 = []
 lines4 = []
...
if __name__=="__main__":
 ...
 fileout1 = sys.argv[3] # tempprev_cfr.tsv  lines 1- lastlnum
 fileout2 = sys.argv[4] # scott_mw_tsv
 fileout3 = sys.argv[5] # tempother.tsv
 fileout4 = sys.argv[6] # probable mal-formed lines
 lines = read_lines(filein)
 lines1,lines2,lines3,lines4,scott_dicts = partiion_lines(lastlnum,lines)
