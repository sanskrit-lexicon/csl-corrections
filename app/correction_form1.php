...
*/
 ...
 $id = $_GET['id'];
 if (!$id) {$id = '?';}
 $jsonfile = "../../csl-json/" . $dict . "/" . $id . ".json";
...
<form action="correction_form_response1.php"
<?php
...
&nbsp;&nbsp;
<input type="text" name="entry_hw" class="ss-q-short" id="entry_hw" dir="auto" aria-label="Headword The headword under which you are submitting a correction " aria-required="true" required="" title="" style="width:80px;position:relative;left:48px;" value="
<?php
if ($id != '?'){
  echo $hw;
}else {
...
<textarea name="entry_new" rows="10" cols="40" class="ss-q-long" id="entry_new" dir="auto" aria-label="New The text that is correct ">
<?php echo $txt; ?>
</textarea>
