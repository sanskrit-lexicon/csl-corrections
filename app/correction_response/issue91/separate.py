""" separate.py  addapted from cfr_adj.py
"""
...
if __name__=="__main__":
 ...
 option_string = option_map[option]
 recs1,recs2 = separate_recs(recs,option_string)
 write_recs(fileout1,recs1)
 write_recs(fileout2,recs2)
